    ...
    >
      ...
      <div className="grid grid-cols-2 items-center">
        <div className="py-4 px-10">
          <p className="text-[11px] text-neutral-400 dark:text-brand-cream/50 font-medium uppercase">
            Chapters / Sections
          </p>
        </div>
      ...
      {sections.map(({ sectionTitle, pages, time }, index) => (
        <div
          ...
          key={index}
        >
          <p className="flex truncate text-xs font-medium text-gray-600 dark:text-brand-cream">
            {sectionTitle}
          </p>
      ...
      <div className="grid grid-cols-2">
        ...
        <div>
          ...
          <div className="flex justify-between items-center px-10 py-3">
            ...
            <p className="flex truncate text-md font-medium dark:text-brand-cream">
