  ...
  return (
    ...
    >
      ...
      <div className="py-4 px-10">
        <p className="text-[11px] text-neutral-400 dark:text-brand-cream/50 font-medium uppercase mb-3">
          Book Language
        </p>
        {languageDetails && (
          <div className="flex gap-2 justify-between items-center w-full">
            <div className="flex gap-3 items-center">
              ...
              <div>
                ...
                <p className="text-xxs text-neutral-400 dark:text-brand-cream">
      ...
      <div className="py-4 pl-10 pr-3">
        ...
        {note ? (
          <div className="pb-4">
            <p className="text-xs font-medium text-neutral-400 dark:text-brand-cream break-words">
              {note}
            </p>
          </div>
        ) : (
