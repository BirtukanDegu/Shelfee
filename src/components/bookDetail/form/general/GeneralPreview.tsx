...
> = ({ bookName, issueDate, dueDate, onClick }) => (
  ...
  >
    ...
    <div>
      <p className="text-[11px] text-neutral-400 dark:text-brand-cream/50 font-semibold uppercase">
        Book Title
      </p>
      <p className="font-medium text-xs dark:text-brand-cream">{bookName}</p>
    </div>
    <div className="flex items-center justify-between pl-10">
      <div>
        ...
        <p className="font-medium text-xs dark:text-brand-cream">
          {issueDate ? format(issueDate, "do MMM yyyy'") : ""}
        </p>
      </div>
      <div>
        <p className="text-[11px] text-neutral-400 dark:text-brand-cream/50 font-semibold uppercase text-right">
          Finish Date
        </p>
        <p className="font-medium text-xs dark:text-brand-cream">
