    ...
    <Controller
      render={({ field: { onChange, value } }) => (
        ...
        >
          ...
          />
          <div
            className="absolute inset-x-0 bottom-0 border-t border-gray-300 peer-hover:border-neutral-400 peer-focus:border-t peer-focus:border-brand-orange border-dashed"
            aria-hidden="true"
          />
        </div>
      )}
