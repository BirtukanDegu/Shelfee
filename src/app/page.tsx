...
const Home = () => {
  ...
  return (
    <div className="flex justify-center items-center overflow-x-hidden">
      <div className="border-l border-r max-w-4xl w-full mx-auto border-dashed h-full flex justify-center flex-col border-gray-300 dark:border-gray-800">
        <div className="flex flex-col justify-center items-center mt-10">
          <Header text="Start shelving with" />
          <Hero />
        </div>
        <div className="justify-center items-center h-full flex flex-col my-10">
          <div className="border-t border-dashed border-gray-300 dark:border-gray-800 w-full mx-auto py-10 flex justify-center items-center relative">
          ...
          <div className="relative group">
            <h1 className="font-semibold text-3xl md:text-7xl text-center w-full border-t border-b py-6 border-dashed text-balance px-4 text-black dark:text-brand-cream border-gray-300 dark:border-gray-800">
          ...
          <div className="pt-10 pb-11 flex gap-3 items-center mx-auto border-gray-300 dark:border-gray-800 border-b w-full justify-center border-dashed relative">
          ...
          <div className=" group border-b  border-dashed text-balance text-center w-full font-semibold border-gray-300 dark:border-gray-800 ">
            <div className="grid grid-cols-2 px-4 relative py-6 text-3xl md:text-7xl max-w-lg mx-auto">
              <div className="flex flex-col border-r border-dashed border-gray-300 dark:border-gray-800">
        ...
        <p className="font-medium text-xl md:text-3xl border-t border-gray-300 dark:border-gray-800 border-b border-dashed md:py-6 py-3 px-7 text-neutral-700 dark:text-brand-cream text-center">
          Here&apos;s why you should use Shelfee
        </p>
        <div className="grid sm:grid-cols-2 relative">
          <Plus className="text-orange-500 group-hover:text-orange-500 w-7 h-7 absolute top-0 -translate-x-1/2 -translate-y-1/2 left-0" />
          <Plus className="text-orange-500 group-hover:text-orange-500 w-7 h-7 absolute bottom-0 right-0 translate-x-1/2 translate-y-1/2" />
          <div className="border-r border-b border-dashed flex justify-center flex-col items-center p-7 border-gray-300 dark:border-gray-800">
            <p className="border flex justify-center items-center w-11 h-11 border-dashed rounded-lg text-2xl text-brand-green mb-5 border-gray-300 dark:border-gray-800 bg-gradient-to-br from-brand-light-green to-brand-cream">
              <Blocks />
            </p>
            <p className="font-bold text-xl text-brand-green">
              Move across shelves
            </p>
            <p className="text-neutral-500 dark:text-brand-cream mt-1 text-center">
              Organize your books into categories as you start, pause, or finish
              them.
            </p>
          </div>
          <div className="border-b border-dashed p-7 border-gray-300 dark:border-gray-800 flex justify-center flex-col items-center">
            <p className="border flex justify-center items-center w-11 h-11 border-dashed rounded-lg text-2xl text-brand-green mb-5 border-gray-300 dark:border-gray-800 bg-gradient-to-br from-brand-light-green to-brand-cream">
              <NotebookPen />
            </p>
            <p className="font-bold text-xl text-brand-green">
          ...
          <div className="border-b border-gray-300 dark:border-gray-800 border-dashed flex justify-center flex-col items-center p-7">
            <p className="border flex justify-center items-center w-11 h-11 border-dashed rounded-lg text-2xl text-brand-green mb-5 border-gray-300 dark:border-gray-800 bg-gradient-to-br from-brand-light-green to-brand-cream">
              <FolderSearch />
            </p>
            <p className="font-bold text-xl text-brand-green">
        ...
        <div className="px-5 py-11 flex justify-center items-center border-b border-dashed border-gray-300 dark:border-gray-800">
        ...
        <div className="flex flex-col justify-center items-center border-b border-dashed mb-20 border-gray-300 dark:border-gray-800 py-10 px-4 gap-4">
          <motion.div
            variants={appear}
            initial="initial"
            animate="animate"
          ...
          <div className="flex gap-4">
            <div className="border flex justify-center items-center w-10 h-10 border-dashed rounded-lg text-2xl text-brand-green border-gray-300 dark:border-gray-800">
              <Link
                target="_blank"
                href="https://github.com/BirtukanDegu/Shelfee"
              >
            ...
            <div className="border flex justify-center items-center w-10 h-10 border-dashed rounded-lg text-2xl text-brand-green border-gray-300 dark:border-gray-800">
              <Link
                target="_blank"
                href="https://www.linkedin.com/in/birtukan-degu-mulusew/"
              >
                <Linkedin />
              </Link>
            </div>
